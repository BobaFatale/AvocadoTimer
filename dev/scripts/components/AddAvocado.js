		...
		return(
			<div>
				<form onSubmit={this.props.handleAdd}>
					...
					<input type="text" id="avocadoName" name="avocadoName" placeholder="Give your avocado a name" value={this.props.avocadoName} onInput={this.props.handleInput} />
					<div className="addAvocado__range">
						<input type="range" min='1' max='14' step='1' value={this.props.daysToRipe} name="daysToRipe" onInput={this.props.handleInput} />
					</div>
					<label htmlFor="daysToRipe">Ripe in # of days:</label>
					<input type="number" id="daysToRipe" name="daysToRipe" value={this.props.daysToRipe} min="1" max="14" onInput={this.props.handleInput}/>
					<div>
